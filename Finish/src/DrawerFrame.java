...
public class DrawerFrame extends JFrame
{
    ...
    DrawerFrame() {
        ...
        JToolBar seletTooBar = new JToolBar();
        seletTooBar.add(canvas.getPointAction());
        seletTooBar.add(canvas.getBoxAction());
        seletTooBar.add(canvas.getLineAction());
        seletTooBar.add(canvas.getCircleAction());
        seletTooBar.add(canvas.getTVAction());
        seletTooBar.add(canvas.getKiteAction());
        seletTooBar.add(canvas.getTextAction());
        seletTooBar.add(new ZoomBox(canvas));
        seletTooBar.add(javax.swing.Box.createGlue());
        container.add(seletTooBar,BorderLayout.NORTH);
        ...
        JMenuItem anotherFile = new JMenuItem("Save As(A)");
        ...
        JMenu figureMenu = new JMenu("Figures(F)");
