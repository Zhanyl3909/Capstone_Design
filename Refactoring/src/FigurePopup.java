...
class FigurePopup extends Popup {
    ...
    FigurePopup(DrawerView view,String title, boolean fillFlag) {
        ...
        blackItem.addActionListener((evt) -> view.setColorForSelectedFigure(Color.BLACK));
        colorMenu.add(blackItem);

        JMenuItem redItem = new JMenuItem("Red");
        redItem.addActionListener((evt) -> view.setColorForSelectedFigure(Color.RED));
        colorMenu.add(redItem);

        JMenuItem greenItem = new JMenuItem("Green");
        greenItem.addActionListener((evt) -> view.setColorForSelectedFigure(Color.GREEN));
        colorMenu.add(greenItem);

        JMenuItem blueItem = new JMenuItem("Blue");
        blueItem.addActionListener((evt) -> view.setColorForSelectedFigure(Color.BLUE));
